...
/**
 * @file mbmcs_STD_2STATE_RELAY.c
 * @ 標準的な2接点リレーの遅延開閉を制御します。
 **/
...
/**
 * @fn int mbmcs_std_2state_relay_ctrl_init(mbmcs_std_2state_relay_ctrl_t * const self_p, const uintptr_t base_addr)
